...
export const de: Translations = {
  ...
  printerClockOffTitle: 'Die Uhr des Druckers geht falsch',
  printerClockOffTimes: 'Drucker: {printer} · Computer: {local}',
  printerClockOffBody: 'Die App gleicht die Abweichung von etwa {amount} aus. Drucke werden trotzdem erkannt und mit der richtigen Zeit gespeichert. Tipp: Schalte am Drucker den Zeitabgleich (NTP) ein.',
  printerClockAnd: '{a} und {b}',
  printerClockMinutes: { one: '{count} Minute', other: '{count} Minuten' },
  printerClockHours: { one: '{count} Stunde', other: '{count} Stunden' },
  printerClockDays: { one: '{count} Tag', other: '{count} Tagen' },
  printerClockMonths: { one: '{count} Monat', other: '{count} Monaten' },
  printerClockYears: { one: '{count} Jahr', other: '{count} Jahren' },

...
- **Werkzeuge** — Abschnitt in der Seitenleiste mit Warteschlange, „Zuletzt angesehen“, „Neu hinzugefügt“, „Duplikate“, Aufräum-Vorschlägen, Filament-Lager und Papierkorb, jeweils mit Anzahl; die Ansichten filtern den Katalog und lassen sich mit Ordnern, Tags und Suche kombinieren.
...
- **Tools** — a sidebar section with the print queue, "Recently viewed", "Recently added", "Duplicates", cleanup suggestions, filament inventory and trash, each with a count; the views filter the catalog and combine with folders, tags and search.

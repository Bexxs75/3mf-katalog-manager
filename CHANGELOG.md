...
- **Werkzeuge in der Seitenleiste:** Ein neuer Abschnitt bündelt die Warteschlange (aufklappbar, wie bisher mit Ziehen zum Umsortieren), die Ansichten „Zuletzt angesehen“ (die 20 zuletzt angesehenen Modelle), „Neu hinzugefügt“ (letzte 7 Tage) und „Duplikate“ (Modelle mit identischem Dateiinhalt, gruppiert) sowie Aufräum-Vorschläge, Filament-Lager und Papierkorb – jeweils mit Anzahl. Eine gewählte Ansicht erscheint oben als Filter-Chip und lässt sich mit Ordnern, Tags und Suche kombinieren.

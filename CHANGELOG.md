...
- Filament-Lager: **Drucker & AMS-Fächer**. Drucker und ihre Mehrfarbeinheiten lassen sich über „Drucker verwalten" anlegen – mit Vorlagen für Bambu AMS/AMS lite/AMS HT, Creality CFS, Prusa MMU3, Anycubic ACE Pro und externe Spule oder als eigene Einheit mit 1–16 Fächern; Name und Reihenfolge änderbar. Spulen kommen per Drag & Drop oder über das Menü am Fach hinein; ein belegtes Fach wird getauscht, von Fach zu Fach wird verschoben. Eingelegte Spulen stehen in einer eigenen Spalte rechts neben dem Lager und zählen weiter im Gesamtbestand. Beim Herausnehmen kehrt eine Spule automatisch an ihren Stammplatz zurück (Hinweis mit „Ändern"). Löschen einer Einheit oder eines Druckers schickt deren Spulen ebenfalls zurück.
